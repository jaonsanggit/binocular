...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VoiceOrder>)))
  ...
  "665c610b7c2ad0cdb9e8600f1fe3adc6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VoiceOrder)))
  "Returns md5sum for a message object of type 'VoiceOrder"
  "665c610b7c2ad0cdb9e8600f1fe3adc6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VoiceOrder>)))
  ...
  (cl:format cl:nil "Header header~%string  emotion~%string  DrinkName~%string  CupNum~%string  Temp~%bool    OrderFinish~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VoiceOrder)))
  "Returns full string definition for message of type 'VoiceOrder"
  (cl:format cl:nil "Header header~%string  emotion~%string  DrinkName~%string  CupNum~%string  Temp~%bool    OrderFinish~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
