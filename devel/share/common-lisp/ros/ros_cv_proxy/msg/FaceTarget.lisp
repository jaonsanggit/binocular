...
(cl:in-package ros_cv_proxy-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <FaceTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FaceTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_cv_proxy-msg:<FaceTarget> is deprecated: use ros_cv_proxy-msg:FaceTarget instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FaceTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cv_proxy-msg:header-val is deprecated.  Use ros_cv_proxy-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <FaceTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cv_proxy-msg:cmd-val is deprecated.  Use ros_cv_proxy-msg:cmd instead.")
  (cmd m))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <FaceTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_cv_proxy-msg:target-val is deprecated.  Use ros_cv_proxy-msg:target instead.")
  (target m))
